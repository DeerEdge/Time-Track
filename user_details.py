class get_user_details():
    def __init__(self):
        ...
        self.grade = str(self.logged_in_user_details[0][7])
        self.events_attended = str(self.logged_in_user_details[0][10])
        self.user_points = str(self.logged_in_user_details[0][11])
        self.user_profile_picture = str(self.logged_in_user_details[0][12])
